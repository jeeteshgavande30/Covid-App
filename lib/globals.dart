library corona_app.globals;

int newActiveCases = 0;
int totalActiveCases = 0;
int newConfirmedCases = 0;
int totalConfirmedCases = 0;
int newDeathCases = 0;
int totalDeathCases = 0;
int newRecoveredCases = 0;
...
List<double> active = [];
List<double> dailyconfirmed = [];
List<double> dailydeaths = [];
List<double> dailyrecovered = [];
List<double> dailyactive = [];
List<double> totalvaccinated = [];
List<double> totalvaccinated1 = [];
List<double> totalvaccinated2 = [];
List<double> vaccinated1 = [];
List<double> vaccinated2 = [];

double casesPieValue = 0;
double deathPieValue = 0;
double recoverPieValue = 0;

late List<String> states = [];
late List<double> activecases = [];
late List<double> confirmedcases = [];
late List<double> recoveredcases = [];
late List<double> deathscases = [];
late List<double> todayactivecases = [];
late List<double> todaydeathscases = [];
late List<double> todayconfirmedcases = [];
late List<double> todayrecoveredcases = [];
...
var statedistdata = {
  ...
  'Puducherry': {'Karaikal': 476, 'Mahe': 477, 'Puducherry': 475, 'Yanam': 478},
  'Punjab': {
    'Amritsar': 485,
    'Barnala': 483,
    'Bathinda': 493,
